...
function ea_site_header() {
    ...
    echo '<div class="nav-header"><a class="nav-header__logo" title="' . get_bloginfo('name') . '" href="' . get_bloginfo('url') . '" style="background: url('. get_stylesheet_directory_uri() .'/assets/images/logo-negative.svg);background-size:cover;">' . get_bloginfo('name') . '</a></div>';
