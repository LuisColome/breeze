...
function ea_site_header() {
    ...
    echo '<div class="nav-header"><a class="nav-header__logo" title="' . get_bloginfo('name') . '" href="' . get_bloginfo('url') . '" style="background: url(' . get_bloginfo('url') . '/wp-content/themes/Breeze/assets/images/logo-negative.png);background-size:cover;">' . get_bloginfo('name') . '</a></div>';
